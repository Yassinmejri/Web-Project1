(function( $ ) {
	...
	$.Shop.prototype = {
		init: function() {
			...
			this.currency = "DT"; // HTML entity of the currency to be displayed in the layout
			this.currencyString = "DT"; // Currency symbol as textual string
			this.paypalCurrency = "DT"; // PayPal's currency code
